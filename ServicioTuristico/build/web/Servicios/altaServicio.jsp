      ...
      <ul class="clear">
        ...
        <li><a class="drop">Empleados</a>
          <ul>
            ...
            <li><a href="verServicios.jsp">Ver Servicios</a></li>
          </ul>
        </li>
        ...
        <div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/01.png');">
            <div id="pageintro" class="hoc clear"> 
                ...
                <form action="../SvServicioAlta" method="POST" class="centrar-contenido">
                    ...
                    <p><label class="one_quarter first">Nombre: </label></th><th> <input type="" name="nombreServicio"></p>
                    <p><label class="one_quarter first">Breve Descripcion: </label></th><th> <input type="text" name="breveDescripcion"></p>
                    <p><label class="one_quarter first">Destino Servicio: </label></th><th> <input type="text" name="destinoServicio"></p>
