...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/mosaico.jpg');">
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h3 class="heading">Turismo Argentino</h3>
      <p>En nuestros servicios siempre dedicamos la mayor atencion al cuidado de los detalles para el maximo disfrute de nuestros clientes.</p>
      <footer><a class="btn" href="#">Paquetes de Turismo</a></footer>
    </article>
    <!-- ################################################################################################ -->
  </div>
</div>
      ...
      <ul class="nospace group btmspace-80 elements elements-four">
        <li class="one_quarter">
          <article><a href="#"><i class="fas fa-hand-rock"></i></a>
            <h6 class="heading">Estadia</h6>
            <p>Mira nuestras opciones de estadia.</p>
          </article>
        </li>
        <li class="one_quarter">
          <article><a href="#"><i class="fas fa-dove"></i></a>
            <h6 class="heading">Actividades</h6>
            <p>Lee nuestro paquete de actividades</p>
          </article>
        </li>
        <li class="one_quarter">
          <article><a href="#"><i class="fas fa-history"></i></a>
            <h6 class="heading">Comidas</h6>
            <p>Elige tus posibles menus de comida.</p>
          </article>
        </li>
        <li class="one_quarter">
          <article><a href="#"><i class="fas fa-heartbeat"></i></a>
            <h6 class="heading">Atención</h6>
            <p>Informate sobre nuestras servicios de salud.</p>
          </article>
        </li>
      </ul>
    </section>
    ...
    <ul class="nospace group elements elements-three">
      <li class="one_third">
        <article><a href="#"><i class="fas fa-hourglass-half"></i></a>
          <h6 class="heading">Clima:</h6>
          <p>En verano, el clima es fresco ccn bastante luz solar.</p>
        </article>
      </li>
      <li class="one_third">
        <article><a href="#"><i class="fas fa-paw"></i></a>
          <h6 class="heading">Mascotas</h6>
          <p>Mira nuestras normativa sobre las mascotas permitidas.</p>
        </article>
      </li>
      <li class="one_third">
        <article><a href="#"><i class="fas fa-sliders-h"></i></a>
          <h6 class="heading">Preferencias</h6>
          <p>Con nuestros sistema de busqueda inteligente decido que quieres encontrar.</p>
        </article>
      </li>
      <li class="one_third">
        <article><a href="#"><i class="fas fa-tty"></i></a>
          <h6 class="heading">Contacto</h6>
          <p>¿Necesitas contactarnos? Aquí tienes nuestros contactos.</p>
        </article>
      </li>
      <li class="one_third">
        <article><a href="#"><i class="fas fa-table"></i></a>
          <h6 class="heading">Paquetes Prediseñados</h6>
          <p>Hemos diseñado paquetes para quienes buscan una experiencia rapida en la compra.</p>
        </article>
      </li>
      <li class="one_third">
        <article><a href="#"><i class="fas fa-hand-holding-usd"></i></a>
          <h6 class="heading">Metodos de pago</h6>
          <p>Revisa que metodo te es mas conveniente para pagar nuestros servicios.</p>
        </article>
      </li>
    </ul>
    <!-- ################################################################################################ -->
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <p class="nospace font-xs">La opinión de nuestros clientes siempre es valida.</p>
      <h6 class="heading font-x2">Reseña de nuestros clientes</h6>
    </div>
    <ul class="pr-charts nospace group center">
      <li class="pr-chart-ctrl" data-animate="false">
        <div class="pr-chart" data-percent="87"><i></i></div>
        <p>Compromiso</p>
      </li>
      <li class="pr-chart-ctrl" data-animate="false">
...
<div class="wrapper row2">
  <section id="ctdetails" class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <p class="nospace font-xs">Siempre puedes hablarnos por</p>
      <h6 class="heading font-x2">Nuestros medios de contacto. </h6>
    </div>
    <figure class="one_half first">
      <ul class="nospace clear">
        <li class="block clear"><a href="#"><i class="fas fa-phone"></i></a> <span><strong>Llamanos:</strong> +54 (123) 456 7890</span></li>
        <li class="block clear"><a href="#"><i class="fas fa-envelope"></i></a> <span><strong>Envianos un mail:</strong> contactanos@TurismoArgentino.com</span></li>
        <li class="block clear"><a href="#"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Visitanos:</strong> En <a href="#"> Ubicación falsa</a></span></li>
      </ul>
    </figure>
    <article class="one_half">
